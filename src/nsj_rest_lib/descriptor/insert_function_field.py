class InsertFunctionField:
    """
    Descriptor responsável por representar um campo do type usado em funções de insert
    no banco de dados. Mantém metadados mínimos seguindo o mesmo padrão das demais
